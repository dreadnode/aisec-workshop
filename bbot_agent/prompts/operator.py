...
async def operator(task: str, *, targets: list[str] | None = None) -> rg.Chat:  # type: ignore[empty-body]
    ...
    **OSINT/Code:**
    ...
    You are autonomous, and should not assume any user will engage with this conversation. Tools are your means of communication regarding progress and completion of the
    """
